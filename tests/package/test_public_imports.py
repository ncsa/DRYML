...
def test_session_facade_is_lazy_and_keeps_legacy_core_session_distinct():
    ...
    _run_fresh_python(
        ...
        "assert tuple(facade.__all__) == ('SelectedWorldAllocation', 'SessionConfiguration', 'SessionConfigurationError', 'SessionSnapshot', 'allocate_world', 'configure', 'current', 'manage', 'mode', 'normalize_configuration', 'require_env', 'reset', 'select_world_allocation', 'set_mode', 'worker_world_request'); "
